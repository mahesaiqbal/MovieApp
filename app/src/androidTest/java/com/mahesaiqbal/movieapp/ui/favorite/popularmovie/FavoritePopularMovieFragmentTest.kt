...
class FavoritePopularMovieFragmentTest {
    ...
    fun loadFavMovies() {
        ...
        onView(withId(R.id.view_pager)).perform(swipeLeft())
        onView(withId(R.id.rv_fav_popular_movie)).check(matches(isDisplayed()))
        onView(withId(R.id.rv_fav_popular_movie)).check(RecyclerViewItemCountAssertion(1))
    }
